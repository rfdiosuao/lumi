...
当前交付口径是 `openclaw_ui_integration` 版本 `2.1.9`。最新完整离线包和在线包使用 OpenClaw runtime `2026.6.5`。

发布资产在 [openclaw-runtime-layers v2.1.9](https://github.com/rfdiosuao/openclaw-runtime-layers/releases/tag/v2.1.9)。
